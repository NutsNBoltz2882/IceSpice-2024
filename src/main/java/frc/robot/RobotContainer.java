...
// Joysticks
  ...
  */
  private RobotContainer() {
    swerveSubsystem.setDefaultCommand(new SwerveDrive(swerveSubsystem, m_driverController));
   ...
   // SmartDashboard.putData("getUp", new getUp( m_chainMount ));
    ...
    SmartDashboard.putData("moveArm", new moveArmUp( m_intake ));
    ...
    SmartDashboard.putData("Plankton's Current Position", m_field);
    SmartDashboard.putBoolean("Is The Arm Down?", m_intake.armStatus);
    SmartDashboard.putBoolean("Is The Arm Up?", !m_intake.armStatus);
...
features.povUp().onTrue(new moveArmDown(m_intake)) ;
features.povDown().onTrue(new moveArmDown(m_intake));
