...
public class IntakeWheels extends SubsystemBase {
   ...
   public static BooleanSupplier inv = () -> areWheelsSpinning;
    ...
    private DoubleSupplier Volts = () -> Math.round( wheels.getAppliedOutput()*12);
    /**
    *
    */
    public IntakeWheels(CommandXboxController trig) {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        wheels = new CANSparkMax(12, MotorType.kBrushless); // Specified motor type
    ...
    public void periodic() {
       ...
       DirectionChanged = wheels.getInverted();
       //sees if the intake wheels are spinnign
    ...
    public boolean areWheelsSpinning() {
        ...
        //sees if the wheels are spinning
   ...
   // }
    public void spin(){
       ...
       //if its released it will stop the motor
    }
    public double getOutputVolts(){
       return wheels.getAppliedOutput();
    }
    //gets the wheel voltage^v
    public DoubleSupplier getVolts(){
        return Volts;
    }
    public static BooleanSupplier getMotorDirection(){
        return changedDirection;
    }//makes a bool supplier to get the direction if the motor to send to the shuffleboard
